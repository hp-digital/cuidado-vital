...
export class FichaObstetricaComponent implements OnInit{
  ...
  AbrirControl(){
    this.BsModalControl = this.modalService.show(ControlPrenatalComponent, { backdrop: 'static', class: 'modal-xl'});
    this.BsModalControl.content.AsignarHistoriaClinica(this.idHistoria)
  }
