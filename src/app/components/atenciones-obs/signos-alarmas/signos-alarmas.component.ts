...
export class SignosAlarmasComponent implements OnInit{
  ...
  AsignarObjetoInicial(data:any){
      ...
      if(objHistoria.signosAlarmas != null)
      {
        ...
        objHistoria.signosAlarmas.forEach((element:any)=>{
          ...
          sstf.Medico = element.medico;
          sstf.FechaRegistroPaciente = element.fechaRegistroPaciente;
          sstf.ComentarioPaciente = element.comentarioPaciente;
          sstf.FechaRegistroMedico = element.fechaRegistroMedico;
      ...
      historiaCalidad.SignosAlarmas = signoAlarma;
  ...
  CerrarModal() {
    this.bsModalSignosAlarmas.hide();
    //this.onGuardar();
  }
