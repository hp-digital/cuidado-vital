...
/*       this.objFuncionVital = funcionVital;
  ...
  AbrirKardex(){
    this.modalCuadroControl = this.modalKardex.show(KardexComponent, {backdrop: 'static', class: 'modal-xl'})
    this.modalCuadroControl.content.AsignarHistoriaClinica(this.objHistoria, this.idHistoria);
  }

  AbrirNotaEvolucion(){
    this.modalCuadroControl = this.modalNotaEvolucicion.show(NotaEvolucionComponent, {backdrop: 'static', class: 'modal-xl'})
    this.modalCuadroControl.content.AsignarHistoriaClinica(this.objHistoria, this.idHistoria);
  }

  AbrirHojaMonitoreo(){
    this.modalCuadroControl = this.modalHojaMonitoreo.show(HojaMonitoreoComponent, {backdrop: 'static', class: 'modal-xl'})
    this.modalCuadroControl.content.AsignarHistoriaClinica(this.objHistoria, this.idHistoria);
  }

  AbrirBalanceHidrico(){
    this.modalCuadroControl = this.modalBalanceHidrico.show(BalanceHidricoComponent, {backdrop: 'static', class: 'modal-xl'})
    this.modalCuadroControl.content.AsignarHistoriaClinica(this.objHistoria, this.idHistoria);
  }
